  ...
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <Link
          to="/"
          className="flex items-center space-x-2 bg-gray-100 active:bg-gray-200 text-black px-4 py-2 mt-12 rounded-md transition duration-150"
          title="Return Home"
        >
          <svg
